...
export const LETTER_ANIMALS = {
  'А': { animal: 'астра', emoji: '🌸' },
  'Б': { animal: 'белка', emoji: '🐿️' },
  'В': { animal: 'ворона', emoji: '🐦' },
  'Г': { animal: 'гусь', emoji: '🦢' },
  'Д': { animal: 'дом', emoji: '🏠' },
  'Е': { animal: 'ель', emoji: '🌲' },
  'Ё': { animal: 'ёлка', emoji: '🎄' },
  'Ж': { animal: 'жираф', emoji: '🦒' },
  'З': { animal: 'змея', emoji: '🐍' },
  'И': { animal: 'индюк', emoji: '🦃' },
  'К': { animal: 'кот', emoji: '🐱' },
  'Л': { animal: 'лев', emoji: '🦁' },
  'М': { animal: 'мамонт', emoji: '🦣' },
  'Н': { animal: 'носорог', emoji: '🦏' },
  'О': { animal: 'оса', emoji: '🐝' },
  'П': { animal: 'пингвин', emoji: '🐧' },
  'Р': { animal: 'рак', emoji: '🦀' },
  'С': { animal: 'стегозавр', emoji: '🦕' },
  'Т': { animal: 'тигр', emoji: '🐯' },
  'У': { animal: 'утка', emoji: '🦆' },
  'Ф': { animal: 'филин', emoji: '🦉' },
  'Х': { animal: 'хомяк', emoji: '🐹' },
  'Ц': { animal: 'цапля', emoji: '🦩' },
  'Ч': { animal: 'червяк', emoji: '🪱' },
  'Ш': { animal: 'шмель', emoji: '🐝' },
  'Щ': { animal: 'щука', emoji: '🐟' },
  'Ы': { animal: 'рыба', emoji: '🐟' },
  'Э': { animal: 'эму', emoji: '🦚' },
  'Ю': { animal: 'юла', emoji: '🪀' },
  'Я': { animal: 'ящерица', emoji: '🦎' }
}
